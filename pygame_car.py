...
def display(count, x, y, message_format = 'Score: %d'):
    """display the score"""
   # max_dodged = 10 
...
def crash(x, y):
    ...
    while True:
        ...
        button("Main Menu", 150,250,100,50, green, bright_green, game_intro)
...
def game_intro():
    ...
    while intro:
        ...
        textSurf, textRect = text_object("CodeWings Car Racing !!", largeText)
        textRect.center = ((display_width/2) , (display_height/2))
        game_display.blit(textSurf, textRect)

        button("GO by me!", 150,450,100,50, green, bright_green, game_loop)
        button("Go by AI!", 550,450,100,50, red, bright_red, ai_loop)
...
def ai_loop():
    ...
    thing_startx = random.randrange(160, 590)
    thing_starty = -600
    thing_speed = 5 
    ...
    while not gameExit:
        ...
        if AI.my_AI(x, y, x_change, thing_startx, thing_starty) == AI.left:
            x_change=-10
        elif AI.my_AI(x, y, x_change, thing_startx, thing_starty) == AI.right:
            x_change=10
        ...
        display(dodged, 5, 5)
        display(my_car_x(), 5, 15, "My car x: %d ")
        display(my_car_y(), 5, 25, "My car y: %d ")
        display(my_car_speed(), 5, 35, "My car speed: %d km/h ")
        display(blue_car_x(), 5, 45, "Blue car x: %d ")
        display(blue_car_y(), 5, 55, "Blue car y: %d ")

        if x > display_width - car_width - 150 or x < 170 :
